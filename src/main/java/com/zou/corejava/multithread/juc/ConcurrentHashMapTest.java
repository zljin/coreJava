...
import com.zou.corejava.multithread.ThreadPoolManager;
...
public class ConcurrentHashMapTest {
    ...
    public static void wayOne() {
        ...
        System.out.println("hashMap 统计结果为：" + " " + hashMap);
    ...
    public static void wayTo() throws Exception {
        ...
        System.out.println("concurrentHashMap 统计结果为：" + " " + concurrentHashMap);
    ...
    public static void way3() throws Exception {
        ...
        System.out.println("执行完" + count.get() + "次。结束");
        ThreadPoolManager.THREAD_POOL_EXECUTOR.shutdown();
        System.out.println("concurrentHashMap2 统计结果为：" + " " + concurrentHashMap);
